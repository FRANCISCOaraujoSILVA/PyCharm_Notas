...
# - Os computadores armazenam dados em arquivos
...
# chdir(): Para mudar para um diretório acima
os.chdir('..')
print(os.getcwd())
...
print(os.name)  # nt para Windows, e posix para linux e mac. Também é possível checar com Crtl+(botãoEsquerdo) em name.
print('-----')
