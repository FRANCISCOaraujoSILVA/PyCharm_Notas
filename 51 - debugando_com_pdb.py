...
"""
- Para isso, dê um break point em 'def dividir(a, b)' e 'return int(a) / int(b)', depois clique na joaninha. Depois 
veja os valores dos argumentos na frente da def
...
"""
Precisamos* importar a biblioteca pdb e então utilizar a função set_trace(). Agora, precisamos clicar apenas no run.
...
# Exemplo 2: Novidade, quando queremos executar dois comandos em uma mesma linha devemos separar por ponto e vírgula
...
# Exemplo 3: Aplicando com a nova função função integrada do Python (breakpoint()) - Veja que surge EOF
...
# Exemplo 4: Antes, para imprimir algo deveríamos digitar o nome da variável. Agora (p nomeVariável)
